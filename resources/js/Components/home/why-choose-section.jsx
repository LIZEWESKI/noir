...
export default function WhyChooseSection() {
  ...
  return (
    ...
    <div className="text-center space-y-4 mb-6">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold   bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-gray-100 dark:to-gray-400 font-outfit">
        Why Choose Noir?
        </h2>
